...
PS：在我写完这篇文章之后我就在 Github 看到了和我类似思路但是更加完善的项目：所以这篇文章的 workflow 似乎已经过时了
...
- **国产模型和工具**：我的观察是，Qwen、GLM、minimax 这些模型的口碑都不错，但我还没有系统性实测，所以暂时不做结论。像 Trae 这类国产工具我虽然体验过但是也没有深度体验，所以只保留观察，不给推荐结论。
